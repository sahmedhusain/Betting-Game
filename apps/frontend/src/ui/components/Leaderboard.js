        ...
        return h('div', {
          ...
          h('div', { class: 'flex items-center gap-5 min-w-0' },
            h('div', { class: 'relative shrink-0' },
              h('div', {
                class: `w-14 h-14 flex items-center justify-center rounded-[1.25rem] border shadow-2xl transition-all duration-500
              ...
              h('div', {
                class: `absolute -top-1.5 -right-1.5 w-6 h-6 rounded-full flex items-center justify-center text-[9px] font-black border shadow-xl
            ...
            h('div', { class: 'flex flex-col min-w-0' },
              h('p', { class: 'text-[9px] font-black text-slate-500 uppercase tracking-[0.4em] mb-1' },
                i < 3 ? TEXT.leaderboard.legendary : TEXT.leaderboard.challenger
              ),
          ...
          h('div', { class: 'flex flex-col items-end gap-1 shrink-0 ml-4' },
            h('span', { class: 'text-[8px] font-black text-slate-700 uppercase tracking-widest' }, TEXT.leaderboard.earnings),
