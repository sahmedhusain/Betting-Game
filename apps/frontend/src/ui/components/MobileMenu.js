...
/**
 * Mobile Menu Modal - Full screen overlay matching RulesModal aesthetic
 */
  ...
  return h('div', { 
    ...
    h('div', { class: 'relative flex items-center justify-between p-8 border-b border-white/5 shrink-0 backdrop-blur-md bg-white/[0.02]' },
      h('div', { class: 'flex flex-col' },
        h('span', { class: 'text-[10px] font-black uppercase tracking-[0.4em] text-emerald-500 mb-1' }, 'SYSTEM NAVIGATION'),
    ...
    h('div', { class: 'relative flex-1 overflow-y-auto custom-scrollbar p-8 space-y-12' },
      ...
      h('div', { class: 'flex flex-col gap-4' },
        h('div', { class: 'relative group p-8 rounded-[2.5rem] bg-white/[0.03] border border-white/5 shadow-2xl overflow-hidden' },
          ...
          h('div', { class: 'relative flex items-center justify-between' },
            h('div', { class: 'flex flex-col' },
              h('span', { class: 'text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-1' }, 'Current Standing'),
      ...
      // Navigation Actions
      h('div', { class: 'flex flex-col gap-4' },
        h('p', { class: 'text-[10px] font-black text-slate-600 uppercase tracking-[0.4em] mb-2 px-2' }, 'Controls'),
