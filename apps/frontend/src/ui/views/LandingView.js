...
export function LandingView({ state, engine }) {
  ...
  return h('div', { class: 'relative w-full h-screen overflow-hidden flex flex-col' },
    h('div', { class: 'w-full max-w-7xl mx-auto px-6 pt-16 pb-8 md:pt-24 md:pb-12 lg:h-[90vh] lg:max-h-[800px] flex flex-col animate-fade-in flex-1' },
          ...
          h('div', { class: 'flex flex-col items-start mb-10 shrink-0' },
            ...
            h('div', { class: 'w-14 h-14 flex items-center justify-center group-hover:rotate-12 transition-transform' },
              ...
              h('div', { class: 'flex flex-col' },
                ...
                h('span', { class: 'text-[11px] font-bold tracking-[0.4em] text-emerald-500 uppercase mt-2' }, TEXT.landing.logoSubtitle)
              )
            ),
            // Persistent Title
