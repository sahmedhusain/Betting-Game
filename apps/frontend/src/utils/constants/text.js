export const I18N = {
  en: {
    landing: {
      ...
      title: 'MAHJONG\nBETTING',
      subtitle: 'The most exciting way to bet on Mahjong.',
    ...
    leaderboard: {
      ...
      gameOverMain: 'GAME',
      gameOverSub: 'OVER',
      limitReachedMain: 'GAME OVER',
      limitReachedSub: 'LIMIT REACHED',
      deckExhaustedMain: 'GAME OVER',
      deckExhaustedSub: 'DECK EXHAUSTED',
      cheatMain: 'OPS!',
      cheatSub: 'CHEATING DETECTED',
